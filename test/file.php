...
// Utiliser l'ID pour récupérer les détails de l'annonce depuis la base de données
  ...
  // Vérifier si l'annonce existe
    if ($carDetails) {
//recuperation des images de l'ID
    ...
    <div id="myCarousel" class="carousel slide mb-6 pointer-event" data-bs-ride="carousel">
        <div class="carousel-inner text-center">
            ...
            <div class="carousel-item ">
                <img class="card-img imgcarousel" src="<?= $img2 ?>" alt="Image 1">
            </div>
            <div class="carousel-item ">
                <img class="card-img imgcarousel" src="<?= $img3 ?>" alt="Image 1">
            </div>
            <div class="carousel-item ">
                <img class="card-img imgcarousel" src="<?= $img4 ?>" alt="Image 1">
            </div>
                <!-- Ajouter les deux autres images de la même manière -->
            <?php } ?>
        </div>
